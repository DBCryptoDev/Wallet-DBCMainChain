...
function Bid({ className, isDisabled }: Props): React.ReactElement<Props> {
  ...
  return (
    <>
      ...
      />
      {isOpen && (
        <Modal className={className} header={t<string>("submit gilt bid")} size="large">
          <Modal.Content>
            ...
            <Modal.Columns
              hint={t<string>("The number of periods this bid is to be freezed for, less than the maximum period")}
            >
              <InputNumber
                defaultValue={BN_ONE}
