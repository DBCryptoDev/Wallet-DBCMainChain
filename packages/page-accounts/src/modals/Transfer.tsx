...
function Transfer({
        ...
        try {
          api.tx.balances
            ...
            .then(({ partialFee }): void => {
              ...
              setMaxTransfer(
                maxTransfer.gt(api.consts.balances.existentialDeposit) ? [maxTransfer, false] : [null, true]
              );
            })
            .catch(console.error);
        } catch (error) {
  ...
  return (
    <Modal className="app--accounts-Modal" header={t<string>("Send funds")} size="large">
      <Modal.Content>
