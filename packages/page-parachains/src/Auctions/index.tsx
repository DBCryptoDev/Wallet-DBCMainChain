...
function Auctions({ auctionInfo, campaigns, className, ownedIds, winningData }: Props): React.ReactElement<Props> {
  ...
  return (
    <div className={className}>
      <Summary auctionInfo={auctionInfo} lastWinners={lastWinners} />
      <Button.Group>
        <Bid auctionInfo={auctionInfo} lastWinners={lastWinners} ownedIds={ownedIds} />
      </Button.Group>
      <Auction auctionInfo={auctionInfo} campaigns={campaigns} winningData={winningData} />
    </div>
  );
}
