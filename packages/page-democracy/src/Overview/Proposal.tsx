...
function Proposal({
  className = "",
  value: { balance, image, imageHash, index, proposer, seconds },
    ...
    <tr className={className}>
      ...
      <td className="button">
        <Button.Group>
          ...
          <Seconding deposit={balance} depositors={seconds || []} image={image} proposalId={index} />
        </Button.Group>
      </td>
      <td className="links media--1000">
        <LinkExternal data={index} isLogo type="proposal" />
      </td>
    </tr>
  );
}
