      ...
      {isVotingOpen && (
        <Modal header={t<string>("Vote on proposal")} size="large">
          <Modal.Content>
            ...
            >
              <ProposedAction idNumber={referendumId} proposal={proposal} />
            </Modal.Columns>
            <Modal.Columns
              hint={t<string>(
            ...
            <Modal.Columns
              hint={
                <>
                  ...
                  <p>
                    {t<string>(
                      "Conviction locks do overlap and is additive, meaning that funds locked during a previous vote can be locked again."
                    )}
                  </p>
                </>
              }
            >
              {isCurrentVote && <VoteValue accountId={accountId} autoFocus onChange={setBalance} />}
              <ConvictionDropdown
