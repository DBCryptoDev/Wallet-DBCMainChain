...
function getProposalByMethod(
  bountyProposals: DeriveCollectiveProposal[],
  method: string | undefined
): DeriveCollectiveProposal | undefined {
...
export function proposalNameToDisplay(
  bountyProposal: DeriveCollectiveProposal,
  status: BountyStatus
): string | undefined {
...
export function getProposalToDisplay(
  bountyProposals: DeriveCollectiveProposal[],
  status: BountyStatus
): DeriveCollectiveProposal | null {
