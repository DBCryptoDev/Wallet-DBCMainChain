  ...
  return (
    <SummaryBox>
      <section>
        ...
        <CardSummary label={t<string>("total")}>{formatNumber(totalProposals || 0)}</CardSummary>
      </section>
      <section className="media--1200">
        <CardSummary label={t<string>("approved")}>{formatNumber(approvalCount)}</CardSummary>
      </section>
      <section>
        {value && (
          <CardSummary label={t<string>("available")}>
            <FormatBalance value={value} withSi />
          </CardSummary>
        )}
        {burn && (
          <CardSummary className="media--1000" label={t<string>("next burn")}>
            <FormatBalance value={burn} withSi />
          </CardSummary>
        )}
      </section>
